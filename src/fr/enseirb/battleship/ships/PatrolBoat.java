...
public class PatrolBoat extends Ships {
	private static int nbBox = 3;
	
	public PatrolBoat(String name, String registration, int x, int y, String orientation) throws ShipOutOfBoundsException{
	...
	public String svg(int x, int y, String orientation) {
		...
		if (orientation.equals("vertical")){
			ligne = String.format("<rect width='%d' height='%d' x='%d'  y='%d' style='fill:#ff0000 fill-opacity:0.75;stroke:#000000; stroke-width:1px' id='rect1353' />\n",100,100*nbBox, x, y);
		}
